...
public class TestSortAlgoDynamic {
	...
	public void testKedua() 
	{
		...
		AssertJUnit.assertEquals(sA.selectionSortASCInt(intNext),sA.bubbleSortASCInt(intNext)," KEDUA DATA TIDAK COCOK ");
	}
	...
	public void testPertama()
	{
		...
		AssertJUnit.assertEquals(sA.selectionSortASCInt(intNext),sA.bubbleSortASCInt(intNext)," KEDUA DATA TIDAK COCOK ");		
//		assertEquals(sA.selectionSortASCInt(intNext),"4,5,6,8,9,13,20,22,50,65,99"," KEDUA DATA TIDAK COCOK ");
	}
