...
import latihan.cucumber.scenariotest.NOPCSceneLogin;

public class SceneFirstHook {
	
	
	public static WebDriver driver;
	public static ExtentTest extentTest;
	public static ExtentReports reports = new ExtentReports("target/nopc/extentreport/hrms-scene-login-xr.html");
	...
	public void getResultStatus(Scenario scenario) throws IOException {
		if(scenario.isFailed()) {
			String screenshotPath = Utils.getScreenshot(driver, "NOPC_SceneFirstHooks"+scenario.getName().replace(" ", "_"));
