...
public class PostDataFromExcel {
	...
	public void befTest()
	{
		...
		req = new JSONObject();
		String excelPath = "./data/ExportExcel.xlsx";
	...
	public void testPost(String subId, String fName, String lName, String email, String univName, String address)
	{	
		
		req.put("first_name",fName);	
		req.put("last_name",lName);
		req.put("email",email);
		req.put("univ_name", univName);
